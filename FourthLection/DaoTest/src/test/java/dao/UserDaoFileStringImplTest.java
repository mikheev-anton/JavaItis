...
public class UserDaoFileStringImplTest {

    private UserDaoFileStringImpl testingUsersDao;

    private static final String PATH = "src/test/resourse/test_users_string.txt";
    @Before
